...
//  Chifforobe
//
//  Created by xiankelton on 6/27/16.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var applicationDocumentsDirectory: URL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "kwork.Chifforobe" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "Chifforobe", withExtension: "momd")!
...
//            error: &error) as [NSManagedObject]?
    ...
    func getPhotoData(_ index: Int) -> Data {
        //1
